...
(function () {
  ...
  class UpdatingElement extends HTMLElement {
    ...
    static createProperty(name) {
      ...
      var key = _typeof(name) === 'symbol' ? Symbol() : "__" + name;
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                // Mark state updating...
                _this5._updateState = _this5._updateState | STATE_UPDATE_REQUESTED;
                previousUpdatePromise = _this5._updatePromise;
                _this5._updatePromise = new Promise(function (res) {
                  return resolve = res;
              ...
              case 8:
                ...
                result = _this5.performUpdate(); // Note, this is to avoid delaying an additional microtask unless we need
                // to.
              ...
              case 12:
                resolve(!_this5._hasRequestedUpdate);
  ...
  */
  ...
  var template = (function (self) {
    return html(_templateObject(), self.prevButtonHandle, self.nextButtonHandle);
  });
  ...
  var fCarousel = class FCarousel extends LitElement {
    ...
    firstUpdated() {
      ...
      this.slideElements = _toConsumableArray(this.children);
    ...
    cloneLastSlide() {
      var lastNode = this.slideElements[this.slideElements.length - 1];
      var cloneLastSlide = lastNode.cloneNode(true);
    ...
    addSlideFirst(node) {
      var translateValue = 100 + (100 - parseInt(this.width));
    ...
    createIndicator() {
      ...
      var indicatorNode = this.shadowRoot.querySelector('.indicator');
      var bullets = [];
    ...
    nextButtonHandle() {
      ...
      clearInterval(this.autoPlayInterval);
      this.nextSlide().then(function () {
        _this2.nextFlag = false;
        _this2.prevFlag = false;
    ...
    prevButtonHandle() {
      ...
      clearInterval(this.autoPlayInterval);
      this.prevSlide().then(function () {
        _this3.nextFlag = false;
        _this3.prevFlag = false;
    ...
    nextSlide() {
      ...
      return new Promise(function (resolve) {
        _this4.nextFlag = true;
        _this4.selectedElement = _this4.slideElements[_this4.index];

        var resetNodes = _this4.getResetNodes();

        _this4.resetStyle(resetNodes);

        _this4.nextNode = _this4.getNextNode();
        _this4.afterNextNode = _this4.getAfterNextNode();

        _this4.currentNextSlideAnim(_this4.selectedElement);

        _this4.slideInSlide(_this4.nextNode);

        _this4.removeSelected(_this4.selectedElement);

        _this4.setSelected(_this4.nextNode);

        _this4.resetInitial();

        _this4.slidesWrap.addEventListener('transitionend', function () {
          return _this4.validNextSlide(_this4.afterNextNode);
        });

        _this4.indicatorControll();

        _this4.index = _this4.index < _this4.slideElements.length - 1 ? _this4.index + 1 : 0;
        resolve();
      });
    }
    ...
    prevSlide() {
      ...
      return new Promise(function (resolve) {
        _this5.prevFlag = true;
        _this5.selectedElement = _this5.slideElements[_this5.index];

        var resetNodes = _this5.getResetNodes();

        _this5.resetStyle(resetNodes);

        _this5.prevNode = _this5.getPrevNode();
        _this5.beforePrevNode = _this5.getBeforePrevNode();

        _this5.currentPrevSlideAnim(_this5.selectedElement);

        _this5.slideInSlide(_this5.prevNode);

        _this5.removeSelected(_this5.selectedElement);

        _this5.setSelected(_this5.prevNode);

        _this5.resetInitial();

        _this5.slidesWrap.addEventListener('transitionend', function () {
          return _this5.validPrevSlide(_this5.beforePrevNode);
        });

        _this5.indicatorControll();

        _this5.index = _this5.index > 0 ? _this5.index - 1 : _this5.slideElements.length - 1;
        resolve();
      });
    }
    ...
    getNextNode() {
      var nextNode = this.slideElements[this.index + 1];
      nextNode = nextNode ? nextNode : this.slideElements[0];
      return nextNode;
    }

    getAfterNextNode() {
      var afterNextNode = this.slideElements[this.index + 2];
    ...
    getPrevNode() {
      var prevNode = this.slideElements[this.index - 1];
      prevNode = prevNode ? prevNode : this.slideElements[this.slideElements.length - 1];
      return prevNode;
    }

    getBeforePrevNode() {
      var prevPrevNode = this.slideElements[this.index - 2];
    ...
    getResetNodes() {
      ...
      var resetNodes = [];
      this.slideElements.forEach(function (e) {
...
//# sourceMappingURL=f-carousel.js.map
